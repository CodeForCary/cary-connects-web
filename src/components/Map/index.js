...
class Map extends Component {
  ...
  render() {
    ...
    return (
		...
		<Context.Consumer>
			{(context) => (
				<LeafletMap className="map" onClick={context.getLocation} animate={this.state.animate} maxBounds={this.state.bounds} center={context.state.location} minZoom={this.state.minZoom} zoom={context.state.zoom}>
